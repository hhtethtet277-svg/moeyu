...
BOT_TOKEN = '8971474033:AAHwWl9otpw1rmHhaDTrKQZJkf5FGzxN3iw'
GITHUB_TOKEN = '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'
REPO_OWNER = "hhtethtet277-svg"
REPO_NAME = "moeyu"
ADMIN_ID = "7695807003"
##################
...
async def handle_input(message):
    ...
    if message.chat.id in user_data:
        # လှမ်းစစ်တဲ့စနစ်ကို ကျော်ပြီး တိုက်ရိုက် သိမ်းဆည်းခိုင်းလိုက်ပါတယ်
        user_data[message.chat.id]['session_url'] = url
        await bot.reply_to(
            message, 
            "Session URL အားသိမ်းဆည်းပြီးပါပြီ။\n/scan 6, 7, 8, all, ascii-lower စသည်ဖြင့် မိမိအသုံးပြုလိုတာကို ရွေးပြီး စတင်ပါ။"
        )
